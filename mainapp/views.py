...
def index(request):
    ...
    API_KEY = '4f9700a45c8f438fbac152905250505' # ***************
    ...
    if request.method=='POST':
        ...
        if not API_KEY:
            ...
            return render(request,'index.html',{'checker':'Se debe ingresar la API_KEY correspondiente'})

        if (city== ''):
            print('No value')
            return render(request,'index.html',{'checker':'El campo ciudad no puede quedar vacio'})
            ...
            if response.status_code == 200:
                ...
                return render(request,'index.html',{'static_city':city,'checker':'Se debe ingresar una ciudad valida'})
